...
TEST_PHONE_NUMBER = os.environ.get('TEST_PHONE_NUMBER', '79031234567')
...
def test_register_incoming_call(client):
    response = client.post('/api/calls/incoming', json={
    ...
    assert data['phone_number'] == TEST_PHONE_NUMBER
    assert data['duration'] == 120


def test_register_outgoing_call(client):
    response = client.post('/api/calls/outgoing', json={
        'phone_number': TEST_PHONE_NUMBER,
        'call_time': '2024-07-25T14:30:00',
        'duration': 120
    })
